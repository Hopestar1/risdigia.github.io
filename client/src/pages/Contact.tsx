...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    // Laisser Formspree gérer la soumission naturellement
    // Le formulaire se soumettra via HTML standard
    setSubmitted(true);
  };
    ...
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              {submitted ? (
                ...
                <form 
                  action="https://formspree.io/f/yesborntoshine@gmail.com" 
                  method="POST" 
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Vidéo & Audio">Vidéo & Audio</option>
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <details className="p-4 bg-gray-50 rounded-lg border-2 border-gray-200 cursor-pointer hover:border-yellow-500 transition-colors">
      ...
      <section className="bg-gradient-to-r from-blue-900 to-black text-white py-16">
        <div className="container text-center">
          <h2 className="text-4xl font-bold mb-4">Nous Sommes Basés au Togo</h2>
          <p className="text-xl text-gray-300 mb-2">Togo, Afrique de l'Ouest</p>
          <p className="text-gray-400">Nous servons des clients dans toute l'Afrique et au-delà</p>
        </div>
      </section>
      ...
      <section className="bg-white py-16">
        <div className="container text-center">
          <h2 className="text-4xl font-bold text-blue-900 mb-6">Transformons Votre Vision en Réalité</h2>
          <p className="text-xl text-gray-700 mb-8">
            Que vous ayez une idée claire ou besoin de conseils, notre équipe est là pour vous aider
          </p>
          <a
            href="#contact"
            className="inline-block px-12 py-4 bg-blue-900 text-white font-bold rounded-lg hover:bg-blue-800 transition-all duration-200 hover:scale-105"
          >
